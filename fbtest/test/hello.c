/*************************************************************************
	...
	> Author: 
	> Mail: 
	> Created Time: Sun 20 Mar 2022 05:35:39 PM CST
 ************************************************************************/
 #include <stdio.h>
#include <stdlib.h>
#include <check.h>
...
START_TEST(test_ppp) {
    if(printData("asd",3) == 3){
        printf("right\n");
    }
    ck_assert_msg(printData("asd",3)==3,"yes");
}
END_TEST
START_TEST(test_sub) {
